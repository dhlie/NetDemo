...
public interface Api {
    ...
    @Headers(NetService.HEADER_DOMAIN_PREFIX + Domain.TAOBAO)
    ...
    @Headers(NetService.HEADER_DOMAIN_PREFIX + Domain.SINA)
    ...
    @Headers(NetService.HEADER_DOMAIN_PREFIX + Domain.ALIYUN)
    @GET("/regeocoding?l=39.938133,116.395739&type=001")
    Observable<Location> queryLocation();

    @Headers(NetService.HEADER_DOMAIN_PREFIX + Domain.REST)
    @GET("/share/words")
